<#
.SYNOPSIS
    AICA Project Build Script (Home Edition)
.DESCRIPTION
...
.EXAMPLE
    .\buildinhome.ps1
    .\buildinhome.ps1 -Configuration Release
    .\buildinhome.ps1 -Clean -Restore
#>
...
Write-Host "  (Home Edition)" -ForegroundColor Magenta
Write-Host "========================================" -ForegroundColor Magenta
Write-Host ""
...
if (-not $msbuild) {
    $found = Get-ChildItem "D:\Visual Studio\*\MSBuild\Current\Bin\MSBuild.exe" -ErrorAction SilentlyContinue | Select-Object -First 1
    if (-not $found) {
...
$solutionPath = "D:\project\AICA\AICA.sln"
$startTime = Get-Date
