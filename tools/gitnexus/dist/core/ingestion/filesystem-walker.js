...
/** Skip files larger than this threshold. Configurable via GITNEXUS_MAX_FILE_SIZE env var (in bytes).
 *  Default 2MB — covers large C/C++ source files while filtering out generated/vendored data.
 *  tree-sitter adaptive buffer (constants.ts) supports up to 32MB. */
const MAX_FILE_SIZE = parseInt(process.env.GITNEXUS_MAX_FILE_SIZE || '', 10) || 2 * 1024 * 1024;
/**
